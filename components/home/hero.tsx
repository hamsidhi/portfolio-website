  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center opacity-[0.07] animate-rotate-slow pointer-events-none" aria-hidden>
      <svg width="700" height="700" viewBox="0 0 700 700" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* Outer ring */}
        <circle cx="350" cy="350" r="300" stroke="#3B82F6" strokeWidth="1" fill="none" opacity="0.5" />
      </svg>
    </div>
  )
}
...
export function Hero() {
  return (
    <section className="relative overflow-hidden min-h-screen flex items-center">
      ...
      <div className="relative mx-auto max-w-6xl w-full px-5 pb-20 pt-32 lg:px-8 lg:pt-40">
        <div className="flex flex-col items-center text-center">
          ...
          >
            <span className="inline-flex flex-wrap items-center gap-x-2 gap-y-1 rounded-full glass-panel px-4 py-1.5 text-xs text-foreground shadow-lg border-blue-500/20 bg-blue-500/5">
          ...
          >
            <motion.div variants={item}>
              <Link
                href="/projects"
                className="group inline-flex items-center gap-2 rounded-full bg-blue-500 px-7 py-3.5 text-sm font-medium text-white shadow-lg shadow-blue-500/25 transition-all hover:bg-blue-600 hover:shadow-blue-500/40 hover:gap-3 btn-glow"
              >
                Explore My Work
